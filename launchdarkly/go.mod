// Deprecated: HashiCorp is no longer publishing new versions of the prebuilt provider for launchdarkly.
...
// You can continue to use the launchdarkly provider in your CDK for Terraform projects with newer versions of CDKTF,
// but you will need to generate the bindings locally. See https://cdk.tf/imports for details.
module github.com/cdktf/cdktf-provider-launchdarkly-go/launchdarkly/v5
