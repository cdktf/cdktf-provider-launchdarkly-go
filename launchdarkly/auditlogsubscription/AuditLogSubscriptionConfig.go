...
type AuditLogSubscriptionConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.23.0/docs/resources/audit_log_subscription#config AuditLogSubscription#config}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.23.0/docs/resources/audit_log_subscription#integration_key AuditLogSubscription#integration_key}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.23.0/docs/resources/audit_log_subscription#name AuditLogSubscription#name}
	Name *string `field:"required" json:"name" yaml:"name"`
	// Whether or not you want your subscription enabled, i.e. to actively send events.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.23.0/docs/resources/audit_log_subscription#on AuditLogSubscription#on}
	On interface{} `field:"required" json:"on" yaml:"on"`
	// statements block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.23.0/docs/resources/audit_log_subscription#statements AuditLogSubscription#statements}
	Statements interface{} `field:"required" json:"statements" yaml:"statements"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.23.0/docs/resources/audit_log_subscription#id AuditLogSubscription#id}.
	//
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.23.0/docs/resources/audit_log_subscription#tags AuditLogSubscription#tags}
