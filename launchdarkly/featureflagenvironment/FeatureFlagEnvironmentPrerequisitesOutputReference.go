...
func (f *jsiiProxy_FeatureFlagEnvironmentPrerequisitesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FeatureFlagEnvironmentPrerequisitesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
