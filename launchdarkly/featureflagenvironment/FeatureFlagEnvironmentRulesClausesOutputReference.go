...
func (f *jsiiProxy_FeatureFlagEnvironmentRulesClausesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FeatureFlagEnvironmentRulesClausesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
