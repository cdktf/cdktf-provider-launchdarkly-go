...
// Represents a {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.24.0/docs/resources/feature_flag_environment launchdarkly_feature_flag_environment}.
...
// Create a new {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.24.0/docs/resources/feature_flag_environment launchdarkly_feature_flag_environment} Resource.
...
func FeatureFlagEnvironment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateFeatureFlagEnvironment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FeatureFlagEnvironment) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_FeatureFlagEnvironment) HasResourceMove() interface{} {
	var returns interface{}
...
func (f *jsiiProxy_FeatureFlagEnvironment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (f *jsiiProxy_FeatureFlagEnvironment) MoveFromId(id *string) {
...
func (f *jsiiProxy_FeatureFlagEnvironment) MoveTo(moveTarget *string, index interface{}) {
...
func (f *jsiiProxy_FeatureFlagEnvironment) MoveToId(id *string) {
...
func (f *jsiiProxy_FeatureFlagEnvironment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (f *jsiiProxy_FeatureFlagEnvironment) ToHclTerraform() interface{} {
	var returns interface{}
