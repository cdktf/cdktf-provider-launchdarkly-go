...
func (f *jsiiProxy_FeatureFlagEnvironmentFallthroughOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FeatureFlagEnvironmentFallthroughOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
