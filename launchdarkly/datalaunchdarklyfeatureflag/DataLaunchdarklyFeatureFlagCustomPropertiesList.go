...
func (j *jsiiProxy_DataLaunchdarklyFeatureFlagCustomPropertiesList) InternalValue() interface{} {
...
func (j *jsiiProxy_DataLaunchdarklyFeatureFlagCustomPropertiesList)SetInternalValue(val interface{}) {
