...
func (d *jsiiProxy_DataLaunchdarklyFeatureFlagClientSideAvailabilityOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataLaunchdarklyFeatureFlagClientSideAvailabilityOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
