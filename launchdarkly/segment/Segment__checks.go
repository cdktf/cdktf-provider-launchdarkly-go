...
func (s *jsiiProxy_Segment) validateMoveFromIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (s *jsiiProxy_Segment) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (s *jsiiProxy_Segment) validatePutExcludedContextsParameters(value interface{}) error {
	...
	case *[]*SegmentExcludedContexts:
		value := value.(*[]*SegmentExcludedContexts)
	...
	case []*SegmentExcludedContexts:
		value_ := value.([]*SegmentExcludedContexts)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*SegmentExcludedContexts; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_Segment) validatePutIncludedContextsParameters(value interface{}) error {
	...
	case *[]*SegmentIncludedContexts:
		value := value.(*[]*SegmentIncludedContexts)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*SegmentIncludedContexts:
		value_ := value.([]*SegmentIncludedContexts)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*SegmentIncludedContexts; received %#v (a %T)", value, value)
		}
	}
...
func (s *jsiiProxy_Segment) validatePutRulesParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*SegmentRules; received %#v (a %T)", value, value)
		}
	}
