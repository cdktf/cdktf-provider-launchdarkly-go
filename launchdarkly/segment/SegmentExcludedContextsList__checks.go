...
func (s *jsiiProxy_SegmentExcludedContextsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (s *jsiiProxy_SegmentExcludedContextsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
