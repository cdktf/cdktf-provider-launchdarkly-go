...
func (s *jsiiProxy_SegmentRulesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SegmentRulesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
