...
func (a *jsiiProxy_AccessTokenInlineRolesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_AccessTokenInlineRolesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
