...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataLaunchdarklyFlagTrigger)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-launchdarkly.dataLaunchdarklyFlagTrigger.DataLaunchdarklyFlagTriggerConfig",
		reflect.TypeOf((*DataLaunchdarklyFlagTriggerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-launchdarkly.dataLaunchdarklyFlagTrigger.DataLaunchdarklyFlagTriggerInstructions",
		reflect.TypeOf((*DataLaunchdarklyFlagTriggerInstructions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-launchdarkly.dataLaunchdarklyFlagTrigger.DataLaunchdarklyFlagTriggerInstructionsOutputReference",
		reflect.TypeOf((*DataLaunchdarklyFlagTriggerInstructionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
