...
// Represents a {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.3/docs/resources/environment launchdarkly_environment}.
...
// Create a new {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.3/docs/resources/environment launchdarkly_environment} Resource.
...
func Environment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateEnvironment_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (e *jsiiProxy_Environment) AddMoveTarget(moveTarget *string) {
...
func (e *jsiiProxy_Environment) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_Environment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (e *jsiiProxy_Environment) MoveFromId(id *string) {
...
func (e *jsiiProxy_Environment) MoveTo(moveTarget *string, index interface{}) {
...
func (e *jsiiProxy_Environment) MoveToId(id *string) {
...
func (e *jsiiProxy_Environment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (e *jsiiProxy_Environment) ToHclTerraform() interface{} {
	var returns interface{}
