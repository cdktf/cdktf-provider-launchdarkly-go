...
func (e *jsiiProxy_Environment) validateMoveFromIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (e *jsiiProxy_Environment) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (e *jsiiProxy_Environment) validatePutApprovalSettingsParameters(value interface{}) error {
	...
	case *[]*EnvironmentApprovalSettings:
		value := value.(*[]*EnvironmentApprovalSettings)
	...
	case []*EnvironmentApprovalSettings:
		value_ := value.([]*EnvironmentApprovalSettings)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*EnvironmentApprovalSettings; received %#v (a %T)", value, value)
		}
	}
