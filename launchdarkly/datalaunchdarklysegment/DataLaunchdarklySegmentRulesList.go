...
func (j *jsiiProxy_DataLaunchdarklySegmentRulesList) InternalValue() interface{} {
...
func (j *jsiiProxy_DataLaunchdarklySegmentRulesList)SetInternalValue(val interface{}) {
