...
func (j *jsiiProxy_DataLaunchdarklySegmentRulesClausesList) InternalValue() interface{} {
...
func (j *jsiiProxy_DataLaunchdarklySegmentRulesClausesList)SetInternalValue(val interface{}) {
