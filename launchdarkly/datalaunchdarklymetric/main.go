...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataLaunchdarklyMetric)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-launchdarkly.dataLaunchdarklyMetric.DataLaunchdarklyMetricConfig",
		reflect.TypeOf((*DataLaunchdarklyMetricConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-launchdarkly.dataLaunchdarklyMetric.DataLaunchdarklyMetricUrls",
		reflect.TypeOf((*DataLaunchdarklyMetricUrls)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-launchdarkly.dataLaunchdarklyMetric.DataLaunchdarklyMetricUrlsList",
		reflect.TypeOf((*DataLaunchdarklyMetricUrlsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataLaunchdarklyMetricUrlsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
