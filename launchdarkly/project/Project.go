...
// Represents a {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.21.0/docs/resources/project launchdarkly_project}.
type Project interface {
	...
	DefaultClientSideAvailability() ProjectDefaultClientSideAvailabilityList
	DefaultClientSideAvailabilityInput() interface{}
	// Experimental.
	DependsOn() *[]*string
	// Experimental.
	SetDependsOn(val *[]*string)
	Environments() ProjectEnvironmentsList
	EnvironmentsInput() interface{}
	// Experimental.
	...
	PutDefaultClientSideAvailability(value interface{})
	PutEnvironments(value interface{})
	ResetDefaultClientSideAvailability()
	ResetId()
...
func (j *jsiiProxy_Project) DefaultClientSideAvailability() ProjectDefaultClientSideAvailabilityList {
	var returns ProjectDefaultClientSideAvailabilityList
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Project) DefaultClientSideAvailabilityInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Project) Environments() ProjectEnvironmentsList {
	var returns ProjectEnvironmentsList
	_jsii_.Get(
		j,
		"environments",
		&returns,
...
func (j *jsiiProxy_Project) EnvironmentsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"environmentsInput",
...
func (j *jsiiProxy_Project) IncludeInSnippet() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"includeInSnippet",
...
func (j *jsiiProxy_Project) IncludeInSnippetInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Project) Key() *string {
	var returns *string
	_jsii_.Get(
		j,
		"key",
...
func (j *jsiiProxy_Project) KeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyInput",
...
// Create a new {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.21.0/docs/resources/project launchdarkly_project} Resource.
...
func (j *jsiiProxy_Project)SetIncludeInSnippet(val interface{}) {
...
func (j *jsiiProxy_Project)SetKey(val *string) {
...
func (p *jsiiProxy_Project) PutDefaultClientSideAvailability(value interface{}) {
	if err := p.validatePutDefaultClientSideAvailabilityParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		p,
		"putDefaultClientSideAvailability",
		[]interface{}{value},
	)
}

func (p *jsiiProxy_Project) PutEnvironments(value interface{}) {
	if err := p.validatePutEnvironmentsParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		p,
...
func (p *jsiiProxy_Project) ResetDefaultClientSideAvailability() {
	_jsii_.InvokeVoid(
		p,
		"resetDefaultClientSideAvailability",
		nil, // no parameters
...
func (p *jsiiProxy_Project) ResetIncludeInSnippet() {
	_jsii_.InvokeVoid(
		p,
		"resetIncludeInSnippet",
		nil, // no parameters
