...
func (p *jsiiProxy_Project) validatePutDefaultClientSideAvailabilityParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*ProjectDefaultClientSideAvailability:
		value := value.(*[]*ProjectDefaultClientSideAvailability)
	...
	case []*ProjectDefaultClientSideAvailability:
		value_ := value.([]*ProjectDefaultClientSideAvailability)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ProjectDefaultClientSideAvailability; received %#v (a %T)", value, value)
		}
	}
...
func (p *jsiiProxy_Project) validatePutEnvironmentsParameters(value interface{}) error {
	if value == nil {
		return fmt.Errorf("parameter value is required, but nil was provided")
	}
	switch value.(type) {
	...
	case *[]*ProjectEnvironments:
		value := value.(*[]*ProjectEnvironments)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ProjectEnvironments:
		value_ := value.([]*ProjectEnvironments)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ProjectEnvironments; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_Project) validateSetIncludeInSnippetParameters(val interface{}) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
	switch val.(type) {
...
func (j *jsiiProxy_Project) validateSetKeyParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
