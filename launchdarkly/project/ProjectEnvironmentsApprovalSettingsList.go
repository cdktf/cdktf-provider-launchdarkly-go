...
func (p *jsiiProxy_ProjectEnvironmentsApprovalSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_ProjectEnvironmentsApprovalSettingsList) Resolve(context cdktf.IResolveContext) interface{} {
