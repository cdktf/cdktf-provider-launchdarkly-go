...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-launchdarkly.webhook.WebhookConfig",
		reflect.TypeOf((*WebhookConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-launchdarkly.webhook.WebhookStatements",
		reflect.TypeOf((*WebhookStatements)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-launchdarkly.webhook.WebhookStatementsList",
		reflect.TypeOf((*WebhookStatementsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*WebhookStatementsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
