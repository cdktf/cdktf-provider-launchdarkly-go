...
type LaunchdarklyProviderConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.20.0/docs#access_token LaunchdarklyProvider#access_token}
	AccessToken *string `field:"optional" json:"accessToken" yaml:"accessToken"`
	// Alias name.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.20.0/docs#alias LaunchdarklyProvider#alias}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.20.0/docs#api_host LaunchdarklyProvider#api_host}
	ApiHost *string `field:"optional" json:"apiHost" yaml:"apiHost"`
	// The HTTP timeout (in seconds) when making API calls to LaunchDarkly.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.20.0/docs#http_timeout LaunchdarklyProvider#http_timeout}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.20.0/docs#oauth_token LaunchdarklyProvider#oauth_token}
