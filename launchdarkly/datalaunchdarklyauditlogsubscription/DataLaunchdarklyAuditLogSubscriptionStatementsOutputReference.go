...
func (d *jsiiProxy_DataLaunchdarklyAuditLogSubscriptionStatementsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataLaunchdarklyAuditLogSubscriptionStatementsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
