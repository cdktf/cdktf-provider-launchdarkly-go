...
func (j *jsiiProxy_DataLaunchdarklyAuditLogSubscriptionStatementsList) InternalValue() interface{} {
...
func (j *jsiiProxy_DataLaunchdarklyAuditLogSubscriptionStatementsList)SetInternalValue(val interface{}) {
