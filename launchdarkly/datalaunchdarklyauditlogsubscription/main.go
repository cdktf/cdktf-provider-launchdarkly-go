...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataLaunchdarklyAuditLogSubscription)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-launchdarkly.dataLaunchdarklyAuditLogSubscription.DataLaunchdarklyAuditLogSubscriptionConfig",
		reflect.TypeOf((*DataLaunchdarklyAuditLogSubscriptionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-launchdarkly.dataLaunchdarklyAuditLogSubscription.DataLaunchdarklyAuditLogSubscriptionStatements",
		reflect.TypeOf((*DataLaunchdarklyAuditLogSubscriptionStatements)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-launchdarkly.dataLaunchdarklyAuditLogSubscription.DataLaunchdarklyAuditLogSubscriptionStatementsList",
		reflect.TypeOf((*DataLaunchdarklyAuditLogSubscriptionStatementsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataLaunchdarklyAuditLogSubscriptionStatementsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
