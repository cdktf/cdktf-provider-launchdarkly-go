...
func (j *jsiiProxy_DataLaunchdarklyRelayProxyConfigurationPolicyList) InternalValue() interface{} {
...
func (j *jsiiProxy_DataLaunchdarklyRelayProxyConfigurationPolicyList)SetInternalValue(val interface{}) {
