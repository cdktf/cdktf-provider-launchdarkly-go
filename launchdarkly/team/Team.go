...
// Represents a {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.0/docs/resources/team launchdarkly_team}.
type Team interface {
	...
	RoleAttributes() TeamRoleAttributesList
...
func (j *jsiiProxy_Team) CustomRoleKeys() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"customRoleKeys",
...
func (j *jsiiProxy_Team) CustomRoleKeysInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"customRoleKeysInput",
...
func (j *jsiiProxy_Team) Key() *string {
	var returns *string
	_jsii_.Get(
		j,
		"key",
...
func (j *jsiiProxy_Team) KeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyInput",
...
func (j *jsiiProxy_Team) Maintainers() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"maintainers",
...
func (j *jsiiProxy_Team) MaintainersInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"maintainersInput",
...
func (j *jsiiProxy_Team) MemberIds() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"memberIds",
...
func (j *jsiiProxy_Team) MemberIdsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"memberIdsInput",
...
func (j *jsiiProxy_Team) RoleAttributes() TeamRoleAttributesList {
	var returns TeamRoleAttributesList
	_jsii_.Get(
		j,
		"roleAttributes",
		&returns,
...
func (j *jsiiProxy_Team) RoleAttributesInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"roleAttributesInput",
...
// Create a new {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.0/docs/resources/team launchdarkly_team} Resource.
func NewTeam(scope constructs.Construct, id *string, config *TeamConfig) Team {
	...
	_jsii_.Create(
		"@cdktf/provider-launchdarkly.team.Team",
...
func (j *jsiiProxy_Team)SetCustomRoleKeys(val *[]*string) {
...
func (j *jsiiProxy_Team)SetKey(val *string) {
...
func (j *jsiiProxy_Team)SetMaintainers(val *[]*string) {
	if err := j.validateSetMaintainersParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_Team)SetMemberIds(val *[]*string) {
...
func (t *jsiiProxy_Team) PutRoleAttributes(value interface{}) {
...
func (t *jsiiProxy_Team) ResetCustomRoleKeys() {
	_jsii_.InvokeVoid(
		t,
		"resetCustomRoleKeys",
		nil, // no parameters
...
func (t *jsiiProxy_Team) ResetMaintainers() {
	_jsii_.InvokeVoid(
		t,
		"resetMaintainers",
		nil, // no parameters
...
func (t *jsiiProxy_Team) ResetMemberIds() {
	_jsii_.InvokeVoid(
		t,
		"resetMemberIds",
		nil, // no parameters
...
func (t *jsiiProxy_Team) ResetRoleAttributes() {
	_jsii_.InvokeVoid(
		t,
		"resetRoleAttributes",
		nil, // no parameters
