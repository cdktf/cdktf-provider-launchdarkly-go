...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FlagTrigger)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "putInstructions", GoMethod: "PutInstructions"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-launchdarkly.flagTrigger.FlagTriggerConfig",
		reflect.TypeOf((*FlagTriggerConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-launchdarkly.flagTrigger.FlagTriggerInstructions",
		reflect.TypeOf((*FlagTriggerInstructions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-launchdarkly.flagTrigger.FlagTriggerInstructionsOutputReference",
		reflect.TypeOf((*FlagTriggerInstructionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
