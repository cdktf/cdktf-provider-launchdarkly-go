...
// Represents a {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.23.0/docs/resources/flag_trigger launchdarkly_flag_trigger}.
...
// Create a new {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.23.0/docs/resources/flag_trigger launchdarkly_flag_trigger} Resource.
...
func FlagTrigger_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateFlagTrigger_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (f *jsiiProxy_FlagTrigger) AddMoveTarget(moveTarget *string) {
...
func (f *jsiiProxy_FlagTrigger) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (f *jsiiProxy_FlagTrigger) ToHclTerraform() interface{} {
	var returns interface{}
